...
public class WrapperClassMethods {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("convert Integer Object to double : i1.doubleValue() -> " + i1.doubleValue());
        ...
        System.out.println("convert Double Object to double : d1.doubleValue() -> " + d1.doubleValue());
