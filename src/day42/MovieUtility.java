...
public class MovieUtility {
    ...
    public static void printMovieInformation(Movie movieObj) {
        ...
        System.out.println("The movie "+movieObj.getName()+
                " is "+movieObj.getLength()+" hour long and it's genre is "+movieObj.getGenre());
    ...
    public static void printMovieNameCharacters(Movie movieObj) {
        //TODO YOUR CODE HERE
        String movieName=movieObj.getName().toUpperCase();

        for (int x = 0; x < movieName.length()-1; x++) {
            System.out.print(movieName.charAt(x));
            System.out.print("-");
        }
        System.out.println(movieName.charAt(movieName.length()-1));
    ...
    public static void printShorterMovieName(Movie movieObj1, Movie movieObj2) {
        ...
        if (movieObj1.getLength()<movieObj2.getLength()) {
            System.out.println("The shorter movie is: "+movieObj1.getName());
        }
    }
    ...
    public static boolean isFamilyMovie(Movie movieObj) {
        //TODO YOUR CODE HERE
        if (movieObj.getGenre().equalsIgnoreCase("family")) {
            return true;
        } else {
            return false;
        }
    ...
    public static String getCombinedMovieInfo(Movie movieObj) {
        ...
        //TODO YOUR CODE HERE
        combinedResult=movieObj.getName()+"-"+movieObj.getLength()+"-"+movieObj.getGenre();
    ...
    public static Movie createFamilyMovie(String name, double len) {
        //TODO YOUR CODE HERE
        Movie m1=new Movie(name,len,"Family");
        return m1;
    }
