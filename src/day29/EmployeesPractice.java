...
//
        for (String each:employees) {
            ...
            int indexOfBracket1=each.indexOf("[");
            int indexOfBracket2=each.lastIndexOf("]");
            System.out.println(each.substring(indexOfBracket1+1,indexOfBracket2));
...
//
//
        for (String eachEmp:employees) {

            int indexOfSpace=eachEmp.indexOf(" ");
            int indexOfBracket=eachEmp.indexOf("[");
            int indexOfBrackett=eachEmp.indexOf("]");

            String firstName=eachEmp.substring(0,indexOfSpace);
            String lastName=eachEmp.substring(indexOfSpace+1,indexOfBracket-1);
            String jobTitle=eachEmp.substring(indexOfBracket+1,indexOfBrackett);
        ...
        */
        ...
        for (String each:employees) {
            ...
            int indexOfBracket=each.indexOf("[");
            int indexOfBrackett=each.indexOf("]");
            String jobTitle=each.substring(indexOfBracket+1,indexOfBrackett);

            if (each.contains("Tracy Bartle") && jobTitle.equals("Geological Engineer")) {
            ...
            if (each.contains("Skipper Abrahamsson") && jobTitle.equals("Financial Advisor")) {
        ...
        for (String each:employees) {
            ...
            String jobTitle=each.substring(indexOfBracket+1,indexOfBrackett);
            String firstName=each.substring(0,indexOfSpace);
            String lastName=each.substring(indexOfSpace+1,indexOfBracket-1);
