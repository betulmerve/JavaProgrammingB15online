...
public class CarInventoryThousand {
    ...
    public static void main(String[] args) {
        ...
        for (int x = 0; x < cars.length; x++) {
            ...
            if (cars[x].toLowerCase().startsWith("chevrolet")) {
        ...
        System.out.println("Count of Civic is "+countOfCivic);
        System.out.println("Count of Chevrolet is "+countOfChv);
        ...
        //Task3:Print Make and Model separately in this format
        //Car make is Honda and model is Civic
        //Print only Honda brands car
       ...
       // String eachCar="Honda-Civic";
        ...
        for (String eachCar:cars) {
            ...
            if (eachCarSplitted[0].equals("Honda")) {

                System.out.println("Car make is "+eachCarSplitted[0]+" and model is "+eachCarSplitted[1]);
        ...
        for (String each:cars) {
            ...
            if (each.contains("Toyota")) {
                countOfToyota++;
            }
        }

        //System.out.println("countOfToyota = " + countOfToyota);

        String[] toyotaInventory=new String[countOfToyota];

        int index1=0;
        for (int x = 0; x < cars.length; x++) {

            if (cars[x].contains("Toyota")) {
                toyotaInventory[index1]=cars[x];
                index1++;
            }

        }
        System.out.println(Arrays.toString(toyotaInventory));

        //ya da bu sekilde

        String toyota="";
        for (int i = 0; i <cars.length ; i++) {
            if(cars[i].contains("Toyota")){
                toyota+=cars[i]+",";
            }

        }
        String[] toyotaInventory2=toyota.split(",");

        System.out.println(Arrays.toString(toyotaInventory2));
