...
public class ProductListPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("productList.indexOf(sony) before remove = " + productList.indexOf(sony));
        productList.remove(sony);
        System.out.println("Has Sony TV or not result ="+ productList.contains(sony));
        System.out.println("productList.indexOf(sony) after remove = " + productList.indexOf(sony));
