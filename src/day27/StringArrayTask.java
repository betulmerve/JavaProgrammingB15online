...
public class StringArrayTask {
    ...
    public static void main(String[] args) {
        ...
        for (int x = 0; x < restaurants.length; x++) {
            ...
            System.out.println((x+1)+". "+restaurants[x]);
        ...
        for (int x = 0; x < restaurants.length; x++) {
            ...
            if (restaurants[x].contains("McDonald's")) {
                mcdonalsCount++;
            }
        ...
        for (int x = 0; x < restaurants.length; x++) {
            ...
            if (restaurants[x].contains("Popeye's Chicken")) {
                popeyesCount++;
            }
            if (restaurants[x].contains("Domino's Pizza")) {
                dominosCount++;
            }
            if (restaurants[x].contains("Taco Bell")) {
                tacoBellCount++;
            }

        }
        System.out.println("Popeye's Chicken Count: "+ popeyesCount);
        System.out.println("Domino's Pizza Count: "+ dominosCount);
        System.out.println("Taco Bell Count: "+ tacoBellCount);
        ...
        int mcdonalsCountInTX = 0;

        for (int x = 0; x < restaurants.length; x++) {

            if (restaurants[x].contains("McDonald's") && restaurants[x].contains("TX")) {

                System.out.println((mcdonalsCountInTX+1)+". "+restaurants[x]);
                mcdonalsCountInTX++;
            }
        ...
        //324 Main St,Massena,McDonald's,13662,NY,http://mcdonalds.comhttp://www.mcdonalds.com/?cid=RF:YXT_FM:TP::Yext:Referral
        //McDonald's -> Massena, NY

        String[] rest=restaurants[0].split(",");
        System.out.println(rest[2]+" -> "+rest[1]+", "+rest[4]);
        ...
        for (int x = 0; x < restaurants.length; x++) {
            ...
            String[] rest2=restaurants[x].split(",");
            System.out.println(rest2[2]+" -> "+rest2[1]+", "+rest2[4]);
