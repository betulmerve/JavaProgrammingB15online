...
public class HR_STUFF {
    ...
    public static void main(String[] args) {
        ...
        //yani abstract bir superclasstan direkt object create edemiyoruz
        //fakat variable create ediyoruz
        //icine sub classindan bir object point ediyoruz
        ...
        Employee e1=new HourlyEmployee("Subi", 101, 55, 2000);
                 ...
                 e1=new FullTimeEmployee("Ainure",103,10000);
                 e1.calculateAnnualSalary();
        Employee e2=new FullTimeEmployee("Dennis", 104, 13000);
        Employee e3=new HourlyEmployee("Roksana", 102, 57, 2080);
